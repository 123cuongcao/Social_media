...
public class LoginController {
    ...
    public String login(Model model) {
        model.addAttribute("form_login", new UserLogin());
        return "component/login";
    }

    @RequestMapping(value = "/handle-login", method = RequestMethod.POST)
    public String doLogin(HttpSession session, @ModelAttribute("form_login") @Valid UserLogin userLogin, Model model, BindingResult bindingResult) {
